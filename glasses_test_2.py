...
threshold = 50  # 50 cm
frame_counter = 0
model = YOLO('/home/cse475/StreetSmartz/runs/detect/train/weights/best.pt')
    ...
    try:
        while True:
            ...
            if depth_frame is not None:
                ...
                if too_close_right:
                    text = f"Careful, something is on your right, approximately {dist} meters away"
                    save_text_to_wav(text, "object_right.wav")
                elif too_close_left:
                    text = f"Careful, something is on your left, approximately {dist} meters away"
